...
#define NUM_SERVOS 2
#define NUM_POS 3
#define NUM_SERVO_EVENT (NUM_SERVOS*NUM_POS)
//#define NUM_NATIVE_IO 8 // defined in boards.h
#define NUM_NATIVE_IO_EVENT (NUM_NATIVE_IO*2)

#define MCP_ADDRESS1 0x20  //// Choose address for first mcp23017 board
#define MCP_ADDRESS2 0x21  //// Choose address for second mcp23017 board
...
#define NUM_EVENT ( (NUM_SERVOS * NUM_POS) + ( (NUM_NATIVE_IO + NUM_MCP_IO) *2 ) + ((NUM_PCA_SERVO*4)) )

#define INIT_TO_90  // inti servo to 90 degrees, comment out if you want the servos to initialize to the midpoint. 
