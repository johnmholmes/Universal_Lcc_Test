# Pins A7 (GPA7) and B7 (GPB7) 

On the MCP23017 are not strictly limited to outputs in hardware — but Microchip strongly recommends using them only as outputs due to a silicon errata/bug in many (most modern) chips.
